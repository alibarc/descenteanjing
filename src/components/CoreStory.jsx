...
import heroImg from "../assets/hero.jpg"; // <-- ambil gambar dari assets

const CoreStory = () => {
  return (
    <section className="pt-28 mb-20 max-w-7xl mx-auto">
      {/* GRID UTAMA: TEKS KIRI & GAMBAR KANAN */}
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
        
        {/* KIRI: TEKS CORE STORY */}
        <div>
          <div className="mb-10">
            ...
            <p className="text-gray-300 leading-relaxed text-lg">
              ...
              didirikan sebagai jembatan yang menghubungkan komunitas pelari,
              konservasi, dan budaya lokal.
            </p>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-14">
        ...
        {/* Visi */}
        <div className="bg-[#121212] p-6 rounded-xl shadow-md border border-gray-900">
          <h3 className="text-xl font-bold text-[#DFFF00]">VISI</h3>
          <p className="text-gray-300">
            Menjadi "event trail run" nomor satu di Asia Tenggara yang paling
            dicintai karena integritas dan keindahan alaminya.
          </p>
        </div>
